	...
	<div class="container">
		<div class="card card-container">
			<table class="table">
				<tr>
					<td>		
						<a href="cuenta.php" class="btn btn-primary">Modificar Cuenta</a>
					</td>
					<td>
						<a href="aut_logout.php" class="btn btn-danger">Salir</a>
					</td>
				</tr>
			</table>
			...
			<center>
			<a href="aut_logout.php" class="btn btn-warning">Digitar Código</a>
			<br><br>*Código de identificacion unico.
		</div>
	</div>
</body>
</html>